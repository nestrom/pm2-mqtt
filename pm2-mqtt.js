...
console.log(conf)
  ...
  var params = {
      ...
      heapCurrent : {type:"histogram", topic: '$SYS/broker/heap/current' , value:0 , clean:(data)=>{return (data / 1048576).toFixed(2)}},
      heapMaximum : {type:"metric", topic: '$SYS/broker/heap/maximum' , value:0 , clean:(data)=>{return (data / 1048576).toFixed(2)}},
      mbRecived :{type:"metric", topic: '$SYS/broker/bytes/received' , value:0 , clean:(data)=>{return (data / 1048576).toFixed(2)}},
